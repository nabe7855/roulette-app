...
function Page() {
    ...
    const handleStart = ()=>{
        ...
        if (available.length === 0) {
            alert("すべての質問が出題されました！");
            return;
        }
        const finalDisplay = [
            ...available
        ].sort(()=>Math.random() - 0.5).slice(0, 10);
        setDisplayQuestions(finalDisplay.map((a)=>a.question));
        setIsSpinning(true);
        setSelectedQuestion(null);
    };
    // ルーレット停止後に呼ばれる
    const handleRouletteStop = (topQuestion)=>{
        const resultIndex = questions.findIndex((q)=>q === topQuestion);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                onClick: handleClear,
                                disabled: isSpinning,
                                className: "w-full bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-3 px-6 rounded-lg text-lg",
                                children: "履歴をクリア"
                            }, void 0, false, {
                                fileName: "[project]/src/app/page.tsx",
                                lineNumber: 109,
...
_s(Page, "obPD6DNyQbJvSmvp9lTcxP/gxwo=", false, function() {
    return [
...
//# sourceMappingURL=_32dcb678._.js.map