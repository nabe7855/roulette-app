...
const Roulette = ({ questions, isSpinning, targetQuestion })=>{
    ...
    const gradient = `conic-gradient(from ${-sliceAngle / 2}deg, ${questions.map((_, index)=>`${POP_COLORS[index % POP_COLORS.length]} ${index * sliceAngle}deg, ${POP_COLORS[index % POP_COLORS.length]} ${(index + 1) * sliceAngle}deg`).join(', ')})`;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=_2205046a._.js.map